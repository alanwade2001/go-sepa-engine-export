module github.com/alanwade2001/go-sepa-engine-export

go 1.24.1

require (
	github.com/alanwade2001/go-sepa-engine-data v0.0.0-20250319202010-46296142310e
...
require (
	github.com/alanwade2001/go-sepa-db v0.0.0-20250314181629-ba7d1fd3f464 // indirect
